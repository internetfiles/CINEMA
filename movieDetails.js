...
function openModal() {
  const movieTitle = document.querySelector('.movie_details_title').innerText.trim(); // Get the movie title from the specified element
  fetch('https://api.themoviedb.org/3/search/movie?api_key=3754bca4db6bbf31b3d71ca72cdd0f2b&query=' + movieTitle)
    ...
    .catch(error => {
      ...
      alert('Error searching for movie. Please try again later.');
    });
}
