...
const releasedEpisode = function (curre) {
  return `<a class="released_link" href="https://vidsrc.to/embed/tv/${fetcid}${
    curre.season_number
  }${curre.episode_number}">
   <iframe style="display:block; margin:0 auto;" id="iframe-embed" width="100%" height="100%" scrolling="no" frameborder="0" sandbox="allow-forms allow-scripts allow-same-origin allow-top-navigation"  class="youtubePlayer" src="https://vidsrc.to/embed/tv/${fetcid}${curre.season_number}${curre.episode_number}" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
