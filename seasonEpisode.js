...
const Trailerfunc = function (id) {
  return `<iframe class="youtubePlayer" src="https://www.2embed.cc/embedtv/?id=${id}&s=${
    curre.season_number
  }&e=${curre.episode_number}" width="100%" height="100%" loading="lazy"  frameborder="0" allowfullscreen></iframe>`;
};

const unreleasedEpisodev = function (curre) {
  return `<a class="unreleased_link" href="https://www.2embed.cc/embedtv/?id=${id}&s=${
    curre.season_number
