...
const releasedEpisode = function (curre) {
  return `<a class="released_link" href="https://multiembed.mov/directstream.php?id=${fetcid}&s=${
    curre.season_number
  }&e=${curre.episode_number}">
  <iframe style="display:block; margin:0 auto;" id="iframe-embed" width="100%" height="100%" scrolling="no" frameborder="0"class="youtubePlayer" src="https://multiembed.mov/directstream.php?id=${fetcid}&s=${
    curre.season_number
  }&e=${curre.episode_number}" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
