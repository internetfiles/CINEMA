...
const releasedEpisode = function (curre) {
  return `<iframe style="display:block; margin:0 auto;" id="iframe-embed" width="100%" height="100%" scrolling="no" frameborder="0" class="youtubePlayer" src="https://vidsrc.xyz/embed/tv/${fetcid}/${curre.season_number}/${curre.episode_number}
" allowfullscreen="true" webkitallowfullscreen="true" referrerpolicy="origin" mozallowfullscreen="true" autoplay></iframe>
